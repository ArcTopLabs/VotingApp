...
var appName = "demo";
var url = 'https://api.masterdatanode.com/' + appName + '/vote/';
...
//        alert("hello");
        $(".btn-primary").addClass('disabled');
        html5sticky.vote("lion", "Red");
        return false;
    });
    $('#jellyfish').click(function () {
        $(".btn-primary").addClass('disabled');
        html5sticky.vote("jelly fish", "Blue");
        return false;
    });
    $('#dog').click(function () {
        $(".btn-primary").addClass('disabled');
        html5sticky.vote("dog", "Green");
        return false;
    });
    $('#tiger').click(function () {
        $(".btn-primary").addClass('disabled');
//        alert("hello");
        html5sticky.vote("tiger", "Red");
        return false;
    });
    $('#whale').click(function () {
        $(".btn-primary").addClass('disabled');
        html5sticky.vote("whale", "Blue");
        return false;
    });
    $('#snake').click(function () {
        $(".btn-primary").addClass('disabled');
        html5sticky.vote("snake", "Green");
        return false;
    });

    $('#again').click(function () {
        html5sticky.voteAgain();
        return false;
    });
